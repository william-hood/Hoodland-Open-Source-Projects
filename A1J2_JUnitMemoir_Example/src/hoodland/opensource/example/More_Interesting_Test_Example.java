...
/**
 * This is an example of a more interesting test that logs with Memoir.
...
class More_Interesting_Test_Example {
	...
	static void classSetup() {
		classLog = new JUnitMemoir("More Interesting Test Example", Tools.stdout, null);
	}
    ...
    private Throwable getTestException(JUnitMemoir log) {
        try {
            makeAndPrint();
